...
function animate()
{
	...
	// 	hit++;
	// }
	// if(obstical0.hitTestPoint(player.topleft()) && player.vx <=0)
	// {
	// 	player.x++;
	// 	player.vx = 0;
	// 	player.vy = 0;
	...
	// 	hit++
	// }
	// if(obstical0.hitTestPoint(player.topright()) && player.vx <=0)
	// {
	// 	player.x++;
	// 	player.vx = 0;
	// 	player.vy = 0;
	...
	// 	hit++
	// }
	// if(obstical0.hitTestPoint(player.bottomleft()) && player.vx <=0)
	// {
	// 	player.x++;
	// 	player.vx = 0;
	// 	player.vy = 0;
	...
	// 	hit++
	// }
	// if(obstical0.hitTestPoint(player.bottomight()) && player.vx <=0)
	// {
	// 	player.x++;
	// 	player.vx = 0;
	// 	player.vy = 0;
